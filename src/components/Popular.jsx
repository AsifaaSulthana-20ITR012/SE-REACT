...
function Popular() {
    ...
    const getPopular = async () => {
        ...
        // const REACT_APP_API_KEY="a2924ea53a9f4a8e909579a3db595823";
        if(check) {
            ...
            const api = await fetch(`https://api.spoonacular.com/recipes/random?apiKey=a2924ea53a9f4a8e909579a3db595823&cuisine=American&number=15`);
